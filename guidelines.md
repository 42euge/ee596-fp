...
├── data/            # (Optional) Placeholder for datasets. If data is from public source (e.g. Kaggle) you could include link instead.
...
See PyTorch documentation to save and load your model (https://pytorch.org/tutorials/beginner/saving_loading_models.html Links to an external site.)
Reproducibility
