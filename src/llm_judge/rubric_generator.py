...
class GeneratedRubric:
    """Structured rubric for evaluation, generated by an LLM.

    Contains criteria with names, descriptions, weights, and scoring levels.
    Distinct from src.rubrics.Rubric which uses structured Criterion objects.
    """
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "GeneratedRubric":
    ...
    def __repr__(self) -> str:
        return (
            f"GeneratedRubric(type={self.question_type}, "
...
class RubricGenerator:
    ...
    def generate(
        ...
        Returns:
            Generated GeneratedRubric object
        """
    ...
    def generate_batch(
        ...
        **kwargs,
        ...
        Returns:
            List of GeneratedRubric objects
        """
